...
namespace BookStore3SelfHost
{
    ...
    {
        private static ConnectionStringSettings ConnectionStringSettings = ConfigurationManager.ConnectionStrings["BookDatabase"];
        ...
        public static int Execute(string prSQL, Dictionary<string, Object> prPars)
        {
            ...
            {
                lcDataConnection.ConnectionString = ConnectionStr;
                lcDataConnection.Open(); lcCommand.CommandText = prSQL; SetPars(lcCommand, prPars); return lcCommand.ExecuteNonQuery();
            }
        }
